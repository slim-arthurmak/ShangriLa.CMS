...
{
    public class HorizonClubListBlockController : BlockControllerBase<HorizonClubListBlock>
    {
        private ContentLocator contentLocator;
        private IContentLoader contentLoader;
        public HorizonClubListBlockController(ContentLocator contentLocator, IContentLoader contentLoader) : base(contentLocator, contentLoader)
        {
            this.contentLocator = contentLocator;
            this.contentLoader = contentLoader;
        }

        public override ActionResult Index(HorizonClubListBlock currentBlock)
        {
            HorizonClubListViewModel model = new HorizonClubListViewModel(currentBlock);
        ...
        {
            EditHintCollection<HorizonClubListViewModel, HorizonClubListBlock> editingHints = ViewData.GetEditHints<HorizonClubListViewModel, HorizonClubListBlock>();
